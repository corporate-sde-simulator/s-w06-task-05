...
> **Welcome to Service-Track Week 6, Task 5!**
...
| `src/sessionManager.ts` | Main source code - **has bugs to fix** |
| `src/tokenGenerator.ts` | Supporting code - **may also have bugs** |
| `tests/sessionManager.test.js` | Test file - **add your tests here** |
